...
class MapNetHead(DETRHead):
    ...
    def forward(self, mlvl_feats, lidar_feat, img_metas, prev_bev=None,  only_bev=False):
        ...
        bev_embed,depth, hs, init_reference, inter_references, seg_mask_embed, seg_query_pos = outputs
        ...
        if self.aux_seg['segmap']:
            ...
            seg_query = seg_mask_embed[-1].permute(1, 0, 2)
            seg_query_pos = seg_query_pos.permute(1, 0, 2)
